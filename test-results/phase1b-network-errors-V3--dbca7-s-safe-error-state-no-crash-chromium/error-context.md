...
- Name: phase1b/network-errors.spec.ts >> V3 sandbox — importer API error injection >> import API 400 during file upload shows safe error state, no crash
- Location: tests/e2e/phase1b/network-errors.spec.ts:132:7
