...
- Name: r001-experiment/gesture-probe.spec.ts >> G9 — Bottom nav More tap >> tapping More in bottom nav calls snapMoreTo(morePanelH)
- Location: tests/e2e/r001-experiment/gesture-probe.spec.ts:398:7
...
Call log:
  - waiting for locator('button[aria-label="More — settings and tools"]')
    - locator resolved to <button aria-label="More — settings and tools">…</button>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <div>More</div> from <div role="dialog" aria-modal="true" aria-label="More options">…</div> subtree intercepts pointer events
    ...
    2 × waiting for element to be visible, enabled and stable
      ...
      - scrolling into view if needed
      - done scrolling
      - <div>…</div> from <div role="dialog" aria-modal="true" aria-label="Add or create">…</div> subtree intercepts pointer events
    - retrying click action
      - waiting 100ms
