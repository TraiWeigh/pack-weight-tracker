...
- Name: phase1b/move.spec.ts >> Item Move — native select control >> Move select options include other category names
- Location: tests/e2e/phase1b/move.spec.ts:47:7
