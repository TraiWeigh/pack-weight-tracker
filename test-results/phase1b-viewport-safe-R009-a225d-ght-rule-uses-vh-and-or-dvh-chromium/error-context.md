...
- Name: phase1b/viewport-safe.spec.ts >> R0090/R0091 — bottom nav & safe-area CSS >> MasterList sheet .tw-ms-sheet max-height rule uses vh and/or dvh
- Location: tests/e2e/phase1b/viewport-safe.spec.ts:197:7

# Error details

```
Error: .tw-ms-sheet must have a max-height rule
