...
- Name: phase1b/move.spec.ts >> Item Move — native select control >> Move item from source to destination — item appears in destination
- Location: tests/e2e/phase1b/move.spec.ts:90:7
