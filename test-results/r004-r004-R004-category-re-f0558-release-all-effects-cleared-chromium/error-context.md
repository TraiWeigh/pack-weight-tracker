...
- Name: r004/r004.spec.ts >> R004 category reorder >> exactly one valid target dims while touched; undims on release; all effects cleared
- Location: tests/e2e/r004/r004.spec.ts:320:7
...
Locator:  locator('[data-dimtarget="true"]')
Expected: 1
Received: 0
Timeout:  15000ms
...
Call log:
  ...
  - waiting for locator('[data-dimtarget="true"]')
