...
- Name: phase1b/move.spec.ts >> Item Move — native select control >> Move item — total item count is unchanged (no duplication / deletion)
- Location: tests/e2e/phase1b/move.spec.ts:109:7
