...
- [Swipe-reveal gesture lessons](swipe-reveal-gesture.md) — swallow post-drag click; reorder dim target from ORIGINAL order not hit-test; pointercancel/lostpointercapture cancel path required.
