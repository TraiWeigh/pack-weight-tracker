...
- Name: phase1b/coverage-gaps.spec.ts >> [NEEDS_AUTH] Create New List / Edit View / Track Weight >> Create New List control is disabled on V3 sandbox (confirms classification)
- Location: tests/e2e/phase1b/coverage-gaps.spec.ts:24:7
