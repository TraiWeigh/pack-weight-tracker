...
const styles = StyleSheet.create({
  ...
  bannerText: { fontSize: 12, fontFamily: 'PlusJakartaSans_400Regular', color: NAV_INACTIVE, lineHeight: 17 },
  clearPill: {
  ...
  clearPillText: { fontSize: 15, fontFamily: 'PlusJakartaSans_600SemiBold', color: '#FFFFFF' },
  ...
  brand: { fontSize: 22, fontFamily: 'PlusJakartaSans_700Bold', color: '#2D5A27' },
  documentType: { fontSize: 14, fontFamily: 'PlusJakartaSans_400Regular', color: '#777777' },
  ...
  weightLabel: { fontSize: 7.5, fontFamily: 'PlusJakartaSans_600SemiBold', color: '#888888', textTransform: 'uppercase', textAlign: 'center' },
  weightValue: { fontSize: 12, fontFamily: 'PlusJakartaSans_700Bold', color: '#1A1A1A', marginTop: 2 },
  ...
  sectionTitle: {
    fontSize: 9, fontFamily: 'PlusJakartaSans_700Bold', color: '#FFFFFF', textTransform: 'uppercase', letterSpacing: 1.2,
  },
  ...
  itemType: { width: 84, fontSize: 11, fontFamily: 'PlusJakartaSans_700Bold', color: '#666666' },
  itemName: { flex: 1, fontSize: 12, color: '#111111' },
  itemWeight: { width: 64, textAlign: 'right', fontSize: 10.5, fontFamily: 'PlusJakartaSans_700Bold', color: '#2D5A27' },
